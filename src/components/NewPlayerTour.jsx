...
function buildSteps(character) {
  ...
  return [
    ...
    },
    {
      ...
      title: 'Divine',
      body: "The Divine section holds abilities and protections granted by great powers in exchange for life-long sacrifices. They work like the Self Improvement skills.",
      cta: 'Next →',
    },
    {
      page: 'skillEditor',
